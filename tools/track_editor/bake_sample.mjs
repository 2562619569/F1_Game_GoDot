...
if (args.length === 0){
  ...
  for (const src of args){
    ...
    const { json, anchorIdx } = bakeTrack({
      ...
      options: { walls: true, wall_height: 0.8, barrier_offset: 8, gravel_width: 8, sample_step: 2, ...S.options },
      routes: S.routes,
    });
