...
14:{ "id":14,  "key":'bump_strength',  "value":0.6,  "note":'Car-car impact boost multiplier (x closing speed x reduced mass)', },
...
17:{ "id":17,  "key":'bump_yaw',  "value":1.0,  "note":'Yaw spin torque multiplier on corner hits', },
